...
使用动画并非是只是让页面变得更有趣，还有以下两个用处

1. **反馈用户操作**

   例如在表单中要提交数据给后台，但是网络连接需要时间，此时可以使用加载动画来告知用户内容已经提交，让他们心里踏实

2. **吸引用户的注意力**

   例如在文本域中输入较多的内容时，可以使用动画快速摇动保存按钮，吸引用户的注意力，提示用户保存他们输入的内容

动画库推荐：https://animista.net/
